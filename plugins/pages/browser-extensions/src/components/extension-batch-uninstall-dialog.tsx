...
interface ExtensionBatchUninstallDialogProps {
  open: boolean;
  count: number;
 ...
 * 批量卸载对话框组件
 */
export function ExtensionBatchUninstallDialog({
  open,
  count,
  onOpenChange,
  onConfirm,
}: ExtensionBatchUninstallDialogProps) {
